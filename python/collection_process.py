## Lab collection in LA associate python.
...
assert sorted_by_name == [
    ...
    {"name": "Kevin Bacon", "age": 61},
    {"name": "Victor Wong", "age": 74},
], f"1.Expected sorted_by_name to equal '{sorted_by_name}' to equal '{[{'name': 'Ariana Richards', 'age': 40}, {'name': 'finn Carter', 'age': 59}, {'name': 'Fred Ward', 'age': 77}, {'name': 'Kevin Bacon', 'age': 61}, {'name': 'Victor Wong', 'age': 74}]}''"
...
# I used f'' with access dict with s['name'] it same '' so it will throw error
...
], f"2.Expected name_declarations to equal '{name_declarations}' to equal '{['Ariana Richards is 40 years old', 'finn Carter is 59 years old', 'Fred Ward is 77 years old', 'Kevin Bacon is 61 years old', 'Victor Wong is 74 years old']}'"
...
# I change mission to need to reverse order because it can complete without sorted and it not fun.

under_seventy = sorted(
    list(filter(lambda s: s['age'] < 70, sorted_by_name)),
    key=lambda s: s['age'],
    reverse=True
)
...
assert under_seventy == [
    ...
    {"name": "finn Carter", "age": 59},
    {"name": "Ariana Richards", "age": 40},    
], f"3.Expected under_seventy to equal '{under_seventy}' to equal '{[{'name': 'Kevin Bacon', 'age': 61}, {'name': 'finn Carter', 'age': 59}, {'name': 'Ariana Richards', 'age': 40}]}'"
