...
try:
    ...
    ), f"1.Expected DatabaseError but got {err.__class__.__name__}"
...
try:
    ...
    ), f"2.Expected MissingEmployeeError but got {err.__class__.__name__}"
...
try:
    ...
    assert (
        err.__class__ == MissingEmployeeError
    ), f"3.Expected MissingEmployeeError but got {err.__class__.__name__}"
